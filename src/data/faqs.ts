...
export const faqs: Faq[] = [
  ...
  { id: 8, category: 'Uso', q: '¿Cuándo empezaré a notar resultados?', a: 'En piel y cabello, entre 4 y 12 semanas de uso consistente. La fotobiomodulación trabaja a nivel celular: los cambios son acumulativos, no instantáneos.' },
  ...
  { id: 11, category: 'Uso', q: '¿Puedo combinarlo con mi rutina de skincare / minoxidil / otros tratamientos?', a: 'Sí. La luz roja es complementaria a la mayoría de tratamientos dermatológicos y capilares. De hecho, muchos profesionales la recomiendan como sinergia.' },
  ...
  { id: 16, category: 'Técnica', q: '¿Qué longitudes de onda usa Vitaly?', a: '660 nanómetros (rojo visible, superficie) y 850 nanómetros (infrarrojo cercano, profundidad). Son las longitudes con mayor evidencia científica para fotobiomodulación en piel, cabello y tejido blando.' },
  { id: 17, category: 'Técnica', q: '¿Cuál es la diferencia entre 660nm y 850nm?', a: 'El 660nm penetra 1-3mm (trabaja sobre piel, colágeno, cicatrización). El 850nm alcanza 3-5cm (músculo, articulación, folículo capilar profundo). La mayoría de dispositivos Vitaly combinan ambas.' },
  { id: 18, category: 'Técnica', q: '¿Es lo mismo que el láser?', a: 'No. El láser concentra la luz en un punto y requiere formación médica. La fotobiomodulación LED difunde la luz sobre un área amplia a intensidad segura — sin dolor, sin calor, sin riesgo de quemadura.' },
