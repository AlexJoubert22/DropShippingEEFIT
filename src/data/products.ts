...
export const products: Product[] = [
  {
    ...
    description: 'Nuestra máscara más avanzada combina tecnología FIR con LEDs cromáticos de grado médico para estimular la producción natural de colágeno a nivel celular. Diseñada para un uso diario de 10 minutos desde la comodidad de casa.',
    price: 349,
    currency: 'EUR',
    ...
    faq: [
      { q: '¿Es seguro para piel sensible y rosácea?', a: 'Sí. La terapia de infrarrojo lejano no emite calor dañino ni rayos UV. De hecho, su principal beneficio es la fuerte reducción de la inflamación, lo que ayuda a calmar pieles reactivas y rosácea.' },
      { q: '¿Cuándo empezaré a notar resultados?', a: 'La respuesta de vibración molecular y microcirculación ocurre en la primera sesión, notando la piel más descansada. A partir de las 4-6 semanas de uso constante notarás mejoras en la textura y jugosidad.' },
      { q: '¿Puedo usar mi rutina de skincare antes de la máscara?', a: 'Recomendamos usarla sobre la piel limpia y seca para máxima penetración térmica. Los serums (idealmente ácido hialurónico) se aplican justo después para potenciar su absorción.' }
    ],
  ...
  },
  {
    ...
    description: 'La ciencia del FIR llevada al folículo. Vitaly Cap utiliza FIR + LEDs cromáticos para aumentar el riego sanguíneo en el cuero cabelludo, prolongar la fase anágena y fomentar una densidad capilar óptima.',
    price: 289,
    currency: 'EUR',
    ...
    benefits: [
      { title: 'Aumenta el grosor del tallo', description: 'Revitaliza los folículos debilitados aportando estímulo vibracional, lo que produce un cabello notablemente más grueso y resistente.' },
  ...
  },
  {
    ...
    description: 'Nuestro dispositivo capilar de grado clínico definitivo. Con una mayor concentración de emisores, Vitaly Halo proporciona cobertura craneal completa para tratar las fases iniciales y medias de la alopecia, promoviendo el despertar folicular mediante tecnología FIR.',
    price: 599,
    currency: 'EUR',
    ...
    benefits: [
      ...
      { title: 'Flujo sanguíneo +25%', description: 'Los emisores penetran con alta irradiancia, estimulando masivamente la microcirculación en áreas con mala vascularización.' },
    ...
    faq: [
      { q: '¿Qué diferencia hay con Vitaly Cap?', a: 'Vitaly Halo incorpora tecnología mixta para mayor penetración celular, cubriendo más área. Está orientado a tratamientos más clínicos.' },
      ...
      { q: '¿Puedo combinarlo con finasteride o minoxidil?', a: 'Sí, la terapia FIR es un excelente complemento potenciador para los tratamientos tópicos u orales pautados por tu dermatólogo.' }
    ],
  ...
  },
  {
    ...
    description: 'La recuperación comienza por la base. Vitaly Step integra emisores FIR localizados en la planta y un diseño de infrarrojo térmico suave, favoreciendo un efecto relajante, reducción de fatiga plantar y sensación de ligereza tras jornadas intensas.',
    price: 149,
    currency: 'EUR',
  ...
  },
  {
    ...
    description: 'El núcleo central de nuestro ecosistema. Un panel de sobremesa ultra-denso que entrega tecnología FIR. Diseñado para optimizar tu ciclo circadiano por la mañana o promover energía focalizada en articulaciones o abdomen.',
    price: 459,
    currency: 'EUR',
    ...
    benefits: [
      { title: 'Regulación circadiana', description: 'Ayuda al despertar natural sin cafeína mediante resonancia de frecuencia matutina.' },
      { title: 'Aporte sistémico celular', description: 'Satura grandes grupos musculares con frecuencias de vibración molecular y microcirculación.' },
      { title: 'Alivio de dolor profundo', description: 'El infrarrojo lejano penetra reduciendo inflamaciones persistentes en lumbares o rodillas.' }
    ],
    ...
    faq: [
      ...
      { q: '¿Daña la vista?', a: 'No, pero para exposiciones frontales directas recomendamos usar las gafas de protección incluidas, especialmente si activas el infrarrojo invisible.' },
  ...
  },
  {
    ...
    description: 'El poder del FIR concentrado en un dispositivo de aluminio anodizado que cabe en tu bolso. Trata de forma precisa arrugas de expresión, rojeces ocasionales o dolor puntual en muñecas y codos allí donde vayas.',
    price: 189,
    currency: 'EUR',
  ...
  },
  {
    ...
    description: 'Fusionamos un gesto cotidiano con ciencia avanzada. Vitaly Brush emite terapia de infrarrojo lejano directamente a través de sus cerdas siliconadas suaves, aportando estimulación folicular y masaje micro-oscilatorio mientras peinas tu melena en menos de 5 minutos.',
    price: 129,
    currency: 'EUR',
  ...
  },
  {
    ...
    description: 'El antídoto para el síndrome del escritorio. Un collar de silicona médica ultra flexible con infrarrojo lejano que libera de forma natural la constricción en trapecios y cervicales de forma pasiva mientras lees o trabajas.',
    price: 179,
    currency: 'EUR',
    ...
    faq: [
      { q: '¿Lleva vibración o es puramente térmico?', a: 'Infrarrojo de resonancia con efecto térmico subyacente. No hay motores. Es totalmente silencioso. La relajación muscular ocurre por la respuesta celular.' },
